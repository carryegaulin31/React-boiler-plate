...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    await queryInterface.createTable('nsn_flis_parts', {
      ...
      RNAAC: { : Sequelize.STRING(2) ,allowNull: false },
      STATUS:{ : Sequelize.STRING(1) ,allowNull: false },
      MSDS: { : Sequelize.STRING(5) ,allowNull: false },
      SADC: { : Sequelize.STRING(2) ,allowNull: false },
      FSC: { : Sequelize.INTEGER(5) ,allowNull: false },
