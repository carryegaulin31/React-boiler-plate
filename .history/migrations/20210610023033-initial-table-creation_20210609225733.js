...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    await queryInterface.createTable('nsn_flis_parts', {
      ...
      RNAAC: { TYPE: Sequelize.char(2) ,allowNull: false },
      STATUS:{ TYPE: Sequelize. { TYPE: Sequelize.char(1) ,allowNull: false },
      MSDS { TYPE: Sequelize.char(5) ,allowNull: false },
      SADC { TYPE: Sequelize.char(2) ,allowNull: false },
