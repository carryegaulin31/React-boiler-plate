...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    await queryInterface.createTable('nsn_flis_parts', {
      ...
      RNAAC: { TYPE: Sequelize.r(2) ,allowNull: false },
      STATUS:{ TYPE: Sequelize.TYPE: Sequelize.r(1) ,allowNull: false },
      MSDS { TYPE: Sequelize.r(5) ,allowNull: false },
      SADC { TYPE: Sequelize.r(2) ,allowNull: false },
