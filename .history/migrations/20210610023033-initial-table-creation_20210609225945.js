...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    await queryInterface.createTable('nsn_flis_parts', {
      ...
      RNAAC: { t: Sequelize.STRING(2) ,allowNull: false },
      STATUS:{ t: Sequelize.STRING(1) ,allowNull: false },
      MSDS: { t: Sequelize.STRING(5) ,allowNull: false },
      SADC: { t: Sequelize.STRING(2) ,allowNull: false },
      FSC: { t: Sequelize.INTEGER(5) ,allowNull: false },
