...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    await queryInterface.createTable('nsn_flis_parts', {
      ...
      RNAAC: { TYPE: Sequelize.(2) ,allowNull: false },
      STATUS:{ TYPE: Sequelize.YPE: Sequelize.(1) ,allowNull: false },
      MSDS { TYPE: Sequelize.(5) ,allowNull: false },
      SADC { TYPE: Sequelize.(2) ,allowNull: false },
