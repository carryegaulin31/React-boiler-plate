...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    await queryInterface.createTable('nsn_flis_parts', {
      ...
      UNPUNCTUATED: Sequelize.STRING(64), allowNull: false },
      CAGE_CODE: { type: Sequelize.CHAR(5),allowNull: false }
      RNCC: { type: Sequelize.('1','2','3','4','5','6','7','8','A','C','D','E'), allowNull: false }
      RNVC set('1','2','3','8','9') ,allowNull: false },
