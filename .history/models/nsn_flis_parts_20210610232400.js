const Nsn_flis_parts = (connection, Sequelize) => connection.define('nsn_flis_parts', {
  // eslint-disable-next-line object-curly-newline
  id: { type: Sequelize.INTEGER(16), autoIncrement: false, allowUnsigned: false, allowNull: false, primaryKey: true },
  ...
  RNCC: { type: Sequelize.ENUM('1', '2', '3', '4', '5', '6', '7', '8', 'A', 'C', 'D', 'E'), allowNull: false },
  RNVC: { type: Sequelize.ENUM('1', '2', '3', '8', '9'), allowNull: false },
