export default (connection, Sequelize) => connection.define('nsn_flis_parts', {id: { type: Sequelize.INTEGER(16), autoIncrement: false, allowUnsigned: false, allowNull: false },
