const Nsn_flis_parts = (connection, Sequelize) => connection.define('nsn_flis_parts', {
  ...
  RNCC: { type: SequelizeENUM('1', '2', '3', '4', '5', '6', '7', '8', 'A', 'C', 'D', 'E'), allowNull: false },
  RNVC: { type: SequelizeENUM('1', '2', '3', '8', '9'), allowNull: false },
  // eslint-disable-next-line max-len
  DAC: { type: SequelizeENUM('1', '2', '3', '4', '5', '6', '9', 'A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'U', 'X'), allowNull: false },
